...
import com.example.warrier.readysetbake.databinding.ActivityStepViewpagerBinding;
...
public class StepsActivity extends AppCompatActivity {
    ...
    private static final String BUNDLE_CURRENT_RECIPE =
            "com.example.warrier.readysetbake.current_recipe";
    private static final String BUNDLE_CURRENT_STEP =
            "com.example.warrier.readysetbake.current_step";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setAdapter(new FragmentStatePagerAdapter(fm) {
            ...
            public Fragment getItem(int position) {
                return StepFrag.newInstance(stepList.get(position));
            }
            @Override
            public int getCount() {
